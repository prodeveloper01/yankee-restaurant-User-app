                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(children: [
                              Text('${getTranslated('order_id', context)}:', style: rubikRegular),
                              SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                              Text('${order.trackModel != null ? order.trackModel.id : ''}', style: rubikMedium),
                              SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                              Expanded(child: SizedBox()),
                              Icon(Icons.watch_later, size: 17),
                              SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                            ...
                            Row(children: [
                              ...
                              ) : order.trackModel.orderType == 'pos' ? Text(getTranslated('pos_order', context), style: poppinsRegular) :
                              order.trackModel.orderType == 'dine_in' ? Text(getTranslated('dine_in', context), style: rubikMedium) :
